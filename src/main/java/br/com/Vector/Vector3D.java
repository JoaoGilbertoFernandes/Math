...
public class Vector3D extends Vector {
    ...
    @Override
    public Vector3D subtract(Vector other) {
    ...
    public Vector3D crossProduct(Vector other) {
    ...
    public static Vector3D random(int range) {
        Vector result = random(SIZE, range);
        return new Vector3D(result.get(0), result.get(1), result.get(2));
    }

    public static Vector3D intRandom(int range) {
    ...
    @Override
    public Vector3D projection(Vector other) {
        Vector result = super.projection(other);
        return new Vector3D(result.get(0), result.get(1), result.get(2));
    }

    @Override
    public Vector3D rejection(Vector other) {
