...
public class AffineFunction extends PolynomialFunction implements Function<Double, Double> {
    ...
    public AffineFunction(@NonNull Vector v, @NonNull Vector u) {
    ...
    private static double slopeComputation(@NonNull Vector v, @NonNull Vector u) {
        Vector subtraction = validateSlopeComputation(v, u);
        return subtraction.get(1) / subtraction.get(0);
    }

    private static @NonNull Vector validateSlopeComputation(@NonNull Vector v, @NonNull Vector u) {
